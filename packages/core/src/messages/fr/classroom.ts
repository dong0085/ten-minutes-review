...
export const classroom: MessageShape<(typeof en)["Classroom"]> = {
  ...
  BankPage: {
    title: "Banque de questions",
    blurb:
      "Tous les points de connaissance tirés de tes notes. Corrige une formulation, ou écarte ce que tu maîtrises déjà pour que les quiz quotidiens l'ignorent.",
    summary: "{active} dans les quiz · {omitted} écartés",
    addNotes: "Ajouter des notes",
    emptyTitle: "La banque est vide",
    empty: "Ajoute des notes et les points de connaissance qu'elles produisent apparaîtront ici.",
    noMatches: "Rien ne correspond à ces filtres.",
    clearFilters: "Effacer les filtres",
    searchPlaceholder: "Chercher des mots, des sens, des notes",
    searchLabel: "Chercher dans la banque",
    allCategories: "Tout",
    statusActive: "Dans les quiz",
    statusOmitted: "Écartés",
    statusAll: "Tout",
    statusLabel: "Afficher",
    categoryLabel: "Catégorie",
    omittedBadge: "Écarté",
    inferredBadge: "Déduit",
    inferredHint: "Le sens a été complété par l'IA car tes notes ne le donnaient pas.",
    stats: "Répondu {answered} · raté {missed}",
    notAsked: "Pas encore interrogé",
    omit: "Écarter",
    restore: "Rétablir",
    omitHint: "Ne plus inclure ce point dans les prochains quiz",
    restoreHint: "Remettre ce point dans les prochains quiz",
    omitSuccess: "Écarté des prochains quiz.",
    restoreSuccess: "De retour dans les prochains quiz.",
    toggleError: "Impossible de mettre à jour ce point de connaissance.",
    edit: "Modifier",
    editTitle: "Modifier le point de connaissance",
    editBlurb:
      "Les changements s'appliquent aux quiz composés à partir de maintenant. Les anciens quiz gardent leur formulation.",
    targetLabel: "Mot ou expression",
    nativeLabel: "Sens",
    noteLabel: "Note",
    sourceLabel: "Tiré de tes notes",
