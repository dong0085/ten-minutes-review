export const privacy = {
  ...
  lede: "Cette page explique ce que Ten Minutes Review conserve et ce qu'il en fait — en termes simples.",
  store: {
  ...
  deletion: {
    ...
    copy: "Tu veux tout effacer ? Écris à <email>contact@ericinottawa.ca</email> et nous supprimerons ton compte et ses données.",
  },
} as const;
